<template>
    <section class="pb-15 pt-[110px]">
        <div class="container">
            <div class="flex gap-x-[70px]">
                ...
                <div class="w-[40%]">
                    <div class="border-[#000] border-b pb-6">
                        ...
                        <h3 class="text-[#000000] text-[24px] font-normal font-poppins leading-6 pb-6">$192.00</h3>
                        <p class="text-[#000] text-[14px] font-normal font-poppins leading-5 pr-22">PlayStation 5 Controller Skin High quality vinyl with air channel adhesive for easy bubble free install & mess free removal Pressure sensitive.</p>
                    </div>
                    <div class="colors flex gap-x-6 items-center pt-6">
                        ...
                        <div class="flex space-x-2">
                            <label v-for="color in 2" :key="color">
                                <input type="radio" name="color" :style="{background:'red'}">
                            </label>
                        </div>
                    </div>
                    <div class="flex gap-x-6 items-center pt-6 sizes" ref="sizes">
                        <div>
                            <h4 class="text-[#000] text-[20px] font-normal font-poppins leading-5">Sizes:</h4>
                        </div>
                        <div class="flex space-x-4">
                            <label v-for="size in 4" :key="size" class="relative">
                                <input type="radio" name="size">
                                <span class="text-[#000] text-[14px] -translate-[50%] absolute font-poppins left-[50%] top-[50%]">XL</span>
                            </label>
                        </div>
                    </div>
            ...
            <div class="pt-[90px] w-[80%]">
                <h3 class="font-poppins font-semibold text-[36px] text-[#111827] leading-10 pb-4">Havic HV G-92 Gamepad</h3>
                <p class="text-[16px] text-[#4B5563] font-poppins font-normal leading-6">The St. Louis Meramec Canoe Company was founded by Alfred Wickett in 1922. Wickett had
...
wooden canoes in Valley Park, Missouri ceased in 1978.</p>
            ...
            <h4 class="font-poppins font-semibold text-[24px] text-[#111827] leading-8 pt-7 pb-7">Features</h4>
            <p class="text-[16px] text-[#4B5563] font-poppins font-normal leading-6">The St. Louis Meramec Canoe Company was founded by Alfred Wickett in 1922. Wickett had
previously worked for the Old Town Canoe Co from 1900 to 1914. Manufacturing of the classic
wooden canoes in Valley Park, Missouri ceased in 1978.</p>
                ...
                <div class="tag pt-15">
                    ...
                    <div class="flex items-center space-x-2">
                        <p v-for="tag in 5" :key="tag" class="flex"><a href=""  class="flex items-center space-x-1 text-[12px] text-[#4B5563] font-poppins font-normal px-[14px] py-2 border border-[#E5E7EB] rounded-2xl">
...
onMounted(() => {
    const inputs = sizes.value.querySelectorAll('input[type="radio"]');
...
.sizes:has(input[type='radio']:checked) span {
  color: #fff;
}
</style>