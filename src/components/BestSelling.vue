    ...
    <section class="pb-[80px]">
        <div class="container">
            <div class="pb-10 flex justify-between">
                <h3 class="text-[36px] text-[#000] font-poppins font-semibold leading-12">Best Selling Products</h3>
                <a href="" class="bg-[#DB4444] px-12 py-4 text-[16px] text-[#FAFAFA] font-poppins font-medium leading-6 rounded-[4px]">View All</a>
            </div>
            <div class="flex gap-x-7">
                <div v-for="newArr in 4" :key="newArr" class="w-1/4">
                   ...
                   <h3 class="font-poppins text-[16px] text-[#000] font-medium leading-6 pb-2">HAVIT HV-G92 Gamepad</h3>
